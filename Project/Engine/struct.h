...
struct tLightInfo
{
	...
	friend ofstream& operator<<(ofstream& _fout, tLightInfo& _out);
	friend ifstream& operator>>(ifstream& _fout, tLightInfo& _out);
};
...
struct tParticleModule
{
	...
	friend ifstream& operator>>(ifstream& fout, tParticleModule& module);
