...
void CAssetMgr::CreateDefaultGraphicsShader()
{
	...
	AddAsset(L"Std2DAlphaShader", pShader.Get());
	...
	// =================================
	pShader = new CGraphicsShader;
	pShader->CreateVertexShader(L"shader\\OnlyAnim.fx", "VS_OnlyAnim");
	pShader->CreatePixelShader(L"shader\\OnlyAnim.fx", "PS_OnlyAnim");
	...
	AddAsset(L"OnlyAnimShader", pShader.Get());
	...
	// =================================
	pShader = new CGraphicsShader;
	pShader->CreateVertexShader(L"shader\\Shaffran.fx", "VS_ShaffranFX");
	pShader->CreatePixelShader(L"shader\\Shaffran.fx", "PS_ShaffranFX");
	...
	AddAsset(L"ShaffranShader", pShader.Get());

	// =================================
	// ProjStdFxShader
	// =================================
	pShader = new CGraphicsShader;
	pShader->CreateVertexShader(L"shader\\ProjStd.fx", "VS_ProjStdFX");
	pShader->CreatePixelShader(L"shader\\ProjStd.fx", "PS_ProjStdFX");
	...
	// =================================
	pShader = new CGraphicsShader;
	pShader->CreateVertexShader(L"shader\\ChangeRed.fx", "VS_ChangeRed");
	pShader->CreatePixelShader(L"shader\\ChangeRed.fx", "PS_ChangeRed");
